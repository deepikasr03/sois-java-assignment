...
public class SaveImage extends Component implements ActionListener {
    ...
    public SaveImage() {
        try {
            bi = ImageIO.read(new File("/Users/rithintl/Downloads/friends.jpg"));
            w = bi.getWidth(null);
            h = bi.getHeight(null);
    ...
    public static void main(String s[]) {
        ...
        f.add("Center", si);
        JComboBox <String> choices = new JComboBox < > (si.getDescriptions());
        choices.setActionCommand("SetFilter");
        choices.addActionListener(si);
        JComboBox <String> formats = new JComboBox < > (si.getFormats());
