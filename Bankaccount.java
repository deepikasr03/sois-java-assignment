/*Design a class to represent a bank account. Include the following members:
  ...
  ->To display the name and balance
		...
		this derive the classes Curr-acct and Sav-acct to make them more specific to their requirements. 
		Include the necessary methods in order to achieve the above mention task.
*/

import java.io.*;


class Bankaccount    //CURRENT ACCOUNT CLASS
{
